...
public class AmbulancesController implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> typeAmbulanceChoiceBox;
    @FXML
    private  ChoiceBox<String> typeAmbulanceChoiceBox1;
    @FXML
    ...
    protected void onAjouterAmbulance(ActionEvent event) {
        ...
        try {
            ...
            if (postResponse.getStatus() == Response.Status.OK.getStatusCode()) {
                gridPane.add(new AmbulanceCard(immatriculation, "F", km), row, column);
